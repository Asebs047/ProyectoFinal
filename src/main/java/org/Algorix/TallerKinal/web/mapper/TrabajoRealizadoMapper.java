...
public interface TrabajoRealizadoMapper {
    ...
    TrabajoRealizadoDto toDto(TrabajoRealizadoEntity entity);
    List<TrabajoRealizadoDto> toDtos(Iterable<TrabajoRealizadoEntity> entities);
    ...
    TrabajoRealizadoEntity toEntity(TrabajoRealizadoDto dto);
