...
public class TrabajoRealizadoEntityRepository implements TrabajoRealizadoRepository {
    ...
    public TrabajoRealizadoDto modificarTrabajo(Long id, ModTrabajoRealozadoDto trabajoRealizadoDto) {
        ...
        // validar que la cita referenciada en la modificación exista
        if (trabajoRealizadoDto != null && trabajoRealizadoDto.idCita() != null && !this.crudCita.existsById(trabajoRealizadoDto.idCita())) {
            throw new CitaNoExiste(trabajoRealizadoDto.idCita());
        }
